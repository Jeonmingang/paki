...
public class Settings {
    ...
    public Settings(FileConfiguration c) {
        ...
        double[] default7 = new double[]{0.18,0.17,0.14,0.04,0.14,0.17,0.16};
    ...
    private Material parseMat(String name) {
        try { return Material.valueOf(name.toUpperCase(Locale.ROOT)); } catch (Exception e) { return innerMaterial; }
    }
    ...
    public int getMaxSimul() { return maxSimul; }
    ...
    public boolean isHudBossbar() { return hudBossbar; }
    public boolean isFxReach() { return fxReach; }
    public String getFxReachTitle() { return fxReachTitle; }
    public String getFxWinTitle() { return fxWinTitle; }
    public String getFxBurstTitle() { return fxBurstTitle; }

    public boolean isVisualDeposit() { return visualDeposit; }
    public double[] getBaseLanes7() { return baseLanes7; }
    public java.util.List<Stage> getStages() { return stages; }

    public Material getEdgeMaterial() { return edgeMaterial; }
    public Material getInnerMaterial() { return innerMaterial; }
    ...
    public boolean hasRowUniform() { return !rowUniform.isEmpty(); }
    ...
    public boolean hasMatrix() { return !matrix.isEmpty(); }
