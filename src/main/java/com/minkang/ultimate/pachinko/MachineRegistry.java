...
public class MachineRegistry {
    ...
    public boolean add(int id, Location base){
    ...
    public void loadFromConfig(){
        ...
        for (String key : sec.getKeys(false)){
            try{
                ...
                map.put(id, new Machine(id, new Location(w,x,y,z)));
    ...
    public void saveToConfig(){
        ...
        for (String k : new ArrayList<>(sec.getKeys(false))) sec.set(k, null);
        for (Machine m : map.values()){
            Location b = m.base;
            String v = b.getWorld().getName()+","+b.getBlockX()+","+b.getBlockY()+","+b.getBlockZ();
