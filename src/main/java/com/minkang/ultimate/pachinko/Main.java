...
public class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new InteractListener(machineManager), this);
        if (getCommand("파칭코") != null) getCommand("파칭코").setExecutor(new PachinkoCommand(machineManager));
