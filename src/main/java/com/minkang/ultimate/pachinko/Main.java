...
public final class Main extends JavaPlugin {
    ...
    public NamespacedKey getBallKey() { return ballKey; }
    public MachineManager getMachineManager() { return machineManager; }
    public FileConfiguration getMachinesConfig() { return machinesConfig; }
    ...
    public void onDisable() {
        ...
        try { machinesConfig.save(machinesFile); } catch (IOException ignored) {}
    ...
    private void setupMachinesYml() {
        ...
        if (!machinesFile.exists()) saveResource("machines.yml", false);
