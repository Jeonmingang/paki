...
public class BallRunner {
    ...
    public void start() {
        // Visual: small ArmorStand with slimeball moving upwards to target hopper
        ...
        final double durationTicks = 40.0; // 2 seconds
        ...
        new BukkitRunnable() {
            ...
            @Override public void run() {
                ...
                as.teleport(cur);
                w.spawnParticle(Particle.REDSTONE, cur, 1, new Particle.DustOptions(Color.LIME, 1.0f));
                t++;
                if (t >= durationTicks) {
