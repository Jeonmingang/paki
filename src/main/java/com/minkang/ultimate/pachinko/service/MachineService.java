...
public class MachineService {
    ...
    public boolean installTemplate(String id, Player p) {
        ...
        // Center column at forward*2, then 7 columns across -3..+3
        ...
        // Bottom materials: [glass, coal, glass, gold, glass, diamond, glass]
        ...
        // Mixed columns above: alternate GLASS and IRON_BARS in a checker pattern
        for (int i=0;i<7;i++) {
        ...
        // Save core machine with main clickable lanes (coal/gold/diamond) only
        Machine m = new Machine(id);
        m.setCoalBase(cols[1]);    // coal column
        m.setGoldBase(cols[3]);    // center gold column
        m.setDiamondBase(cols[5]); // diamond column
        // Keep three canonical hoppers for compatibility
