...
public class ItemUtil {
    public static ItemStack buildItem(Material type, String name, java.util.List<String> lore){
        ...
        if (im!=null){
            if (name!=null && !name.isEmpty()) im.setDisplayName(Text.color(name));
    ...
    public static boolean isSameMarble(ItemStack a, ItemStack b){
        ...
        if (ma!=null && ma.hasDisplayName() && mb!=null && mb.hasDisplayName()){
            String sa = org.bukkit.ChatColor.stripColor(Text.color(ma.getDisplayName()));
            String sb = org.bukkit.ChatColor.stripColor(Text.color(mb.getDisplayName()));
